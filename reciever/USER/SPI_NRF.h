...
#define TX_PLOAD_WIDTH  24   //发射数据通道有效数据宽度0~32Byte 

#define RX_ADR_WIDTH    5
#define RX_PLOAD_WIDTH  24
...
#define NRF_CSN_HIGH()      GPIO_SetBits(GPIOA, GPIO_Pin_5)
#define NRF_CSN_LOW()      GPIO_ResetBits(GPIOA, GPIO_Pin_5)		 //csn置低
